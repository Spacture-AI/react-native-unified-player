...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::unifiedplayer::VideoInformation> final {
    static inline margelo::nitro::unifiedplayer::VideoInformation fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::unifiedplayer::VideoInformation(
        ...
        JSIConverter<margelo::nitro::unifiedplayer::VideoOrientation>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "orientation")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::unifiedplayer::VideoInformation& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "orientation"), JSIConverter<margelo::nitro::unifiedplayer::VideoOrientation>::toJSI(runtime, arg.orientation));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<margelo::nitro::unifiedplayer::VideoOrientation>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "orientation")))) return false;
      return true;
    }
  };
