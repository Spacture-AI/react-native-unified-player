...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::unifiedplayer::CustomVideoMetadata> final {
    static inline margelo::nitro::unifiedplayer::CustomVideoMetadata fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::unifiedplayer::CustomVideoMetadata(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::unifiedplayer::CustomVideoMetadata& arg) {
