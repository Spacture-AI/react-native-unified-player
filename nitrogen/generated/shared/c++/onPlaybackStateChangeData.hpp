...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::unifiedplayer::onPlaybackStateChangeData> final {
    static inline margelo::nitro::unifiedplayer::onPlaybackStateChangeData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::unifiedplayer::onPlaybackStateChangeData(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::unifiedplayer::onPlaybackStateChangeData& arg) {
