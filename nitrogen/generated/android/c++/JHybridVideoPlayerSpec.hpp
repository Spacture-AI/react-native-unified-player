...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    struct JavaPart: public jni::JavaClass<JavaPart, JHybridObject::JavaPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/HybridVideoPlayerSpec;";
      std::shared_ptr<JHybridVideoPlayerSpec> getJHybridVideoPlayerSpec();
    };
    struct CxxPart: public jni::HybridClass<CxxPart, JHybridObject::CxxPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/HybridVideoPlayerSpec$CxxPart;";
  ...
  public:
    ...
    std::shared_ptr<Promise<std::string>> captureFrame() override;
