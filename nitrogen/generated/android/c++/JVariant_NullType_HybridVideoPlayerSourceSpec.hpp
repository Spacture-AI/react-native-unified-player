...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Variant_NullType_HybridVideoPlayerSourceSpec;";
  ...
  namespace JVariant_NullType_HybridVideoPlayerSourceSpec_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Variant_NullType_HybridVideoPlayerSourceSpec$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Variant_NullType_HybridVideoPlayerSourceSpec$Second;";
