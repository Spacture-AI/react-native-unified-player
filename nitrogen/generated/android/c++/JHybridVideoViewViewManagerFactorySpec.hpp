...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    struct JavaPart: public jni::JavaClass<JavaPart, JHybridObject::JavaPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/HybridVideoViewViewManagerFactorySpec;";
      std::shared_ptr<JHybridVideoViewViewManagerFactorySpec> getJHybridVideoViewViewManagerFactorySpec();
    };
    struct CxxPart: public jni::HybridClass<CxxPart, JHybridObject::CxxPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/HybridVideoViewViewManagerFactorySpec$CxxPart;";
