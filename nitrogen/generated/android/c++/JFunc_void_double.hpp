...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Func_void_double;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Func_void_double_cxx;";
