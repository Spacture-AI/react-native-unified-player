...
namespace margelo::nitro::unifiedplayer {
  ...
  std::shared_ptr<Promise<std::string>> JHybridVideoPlayerSpec::captureFrame() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("captureFrame");
    auto __result = method(_javaPart);
    return [&]() {
