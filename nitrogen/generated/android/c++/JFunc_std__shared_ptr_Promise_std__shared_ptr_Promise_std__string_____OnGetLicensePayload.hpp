...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Func_std__shared_ptr_Promise_std__shared_ptr_Promise_std__string_____OnGetLicensePayload;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Func_std__shared_ptr_Promise_std__shared_ptr_Promise_std__string_____OnGetLicensePayload_cxx;";
