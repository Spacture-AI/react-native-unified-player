...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Func_void_cxx;";
