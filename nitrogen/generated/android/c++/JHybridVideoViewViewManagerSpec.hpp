...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    struct JavaPart: public jni::JavaClass<JavaPart, JHybridObject::JavaPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/HybridVideoViewViewManagerSpec;";
      std::shared_ptr<JHybridVideoViewViewManagerSpec> getJHybridVideoViewViewManagerSpec();
    };
    struct CxxPart: public jni::HybridClass<CxxPart, JHybridObject::CxxPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/HybridVideoViewViewManagerSpec$CxxPart;";
