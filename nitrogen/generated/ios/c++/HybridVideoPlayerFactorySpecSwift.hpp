...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    ...
    explicit HybridVideoPlayerFactorySpecSwift(const UnifiedPlayer::HybridVideoPlayerFactorySpec_cxx& swiftPart):
      HybridObject(HybridVideoPlayerFactorySpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline UnifiedPlayer::HybridVideoPlayerFactorySpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    UnifiedPlayer::HybridVideoPlayerFactorySpec_cxx _swiftPart;
  };
