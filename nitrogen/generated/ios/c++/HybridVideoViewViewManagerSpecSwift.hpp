...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    ...
    explicit HybridVideoViewViewManagerSpecSwift(const UnifiedPlayer::HybridVideoViewViewManagerSpec_cxx& swiftPart):
      HybridObject(HybridVideoViewViewManagerSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline UnifiedPlayer::HybridVideoViewViewManagerSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    UnifiedPlayer::HybridVideoViewViewManagerSpec_cxx _swiftPart;
  };
