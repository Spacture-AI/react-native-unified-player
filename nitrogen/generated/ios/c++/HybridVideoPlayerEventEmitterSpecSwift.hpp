...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    ...
    explicit HybridVideoPlayerEventEmitterSpecSwift(const UnifiedPlayer::HybridVideoPlayerEventEmitterSpec_cxx& swiftPart):
      HybridObject(HybridVideoPlayerEventEmitterSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline UnifiedPlayer::HybridVideoPlayerEventEmitterSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    UnifiedPlayer::HybridVideoPlayerEventEmitterSpec_cxx _swiftPart;
  };
