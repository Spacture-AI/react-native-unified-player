...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    ...
    explicit HybridVideoViewViewManagerFactorySpecSwift(const UnifiedPlayer::HybridVideoViewViewManagerFactorySpec_cxx& swiftPart):
      HybridObject(HybridVideoViewViewManagerFactorySpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline UnifiedPlayer::HybridVideoViewViewManagerFactorySpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    UnifiedPlayer::HybridVideoViewViewManagerFactorySpec_cxx _swiftPart;
  };
