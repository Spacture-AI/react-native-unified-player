...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    ...
    explicit HybridVideoPlayerSpecSwift(const UnifiedPlayer::HybridVideoPlayerSpec_cxx& swiftPart):
      HybridObject(HybridVideoPlayerSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline UnifiedPlayer::HybridVideoPlayerSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  public:
    ...
    inline std::shared_ptr<Promise<std::string>> captureFrame() override {
      auto __result = _swiftPart.captureFrame();
      if (__result.hasError()) [[unlikely]] {
        std::rethrow_exception(__result.error());
      }
      auto __value = std::move(__result.value());
  ...
  private:
    UnifiedPlayer::HybridVideoPlayerSpec_cxx _swiftPart;
  };
