...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    ...
    explicit HybridVideoPlayerSourceSpecSwift(const UnifiedPlayer::HybridVideoPlayerSourceSpec_cxx& swiftPart):
      HybridObject(HybridVideoPlayerSourceSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline UnifiedPlayer::HybridVideoPlayerSourceSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    UnifiedPlayer::HybridVideoPlayerSourceSpec_cxx _swiftPart;
  };
