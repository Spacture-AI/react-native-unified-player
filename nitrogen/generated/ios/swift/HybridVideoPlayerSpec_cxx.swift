...
open class HybridVideoPlayerSpec_cxx {
  ...
  public final var mixAudioMode: Int32 {
    ...
    @inline(__always)
    set {
      self.__implementation.mixAudioMode = margelo.nitro.unifiedplayer.MixAudioMode(rawValue: newValue)!
    }
  }
  ...
  public final var ignoreSilentSwitchMode: Int32 {
    ...
    @inline(__always)
    set {
      self.__implementation.ignoreSilentSwitchMode = margelo.nitro.unifiedplayer.IgnoreSilentSwitchMode(rawValue: newValue)!
    }
  }
  ...
  @inline(__always)
  public final func captureFrame() -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.captureFrame()
